...
function typer() {
    var win = $(window),
        foo = $('#typer');
    foo.typer(['<h1><span class="iq-font-purple">IT</span> Network</h1>','<h1><span class="iq-font-purple">Desktop</span> Programming</h1>','<h1><span class="iq-font-purple">Web</span> Developer</h1>']);
